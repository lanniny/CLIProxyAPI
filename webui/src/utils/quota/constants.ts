...
// Kiro uses AWS CodeWhisperer quota API
export const KIRO_QUOTA_URL =
  'https://codewhisperer.us-east-1.amazonaws.com/listAvailableCustomizations';

export const KIRO_REQUEST_HEADERS = {
  Authorization: 'Bearer $TOKEN$',
  'Content-Type': 'application/x-amz-json-1.0',
  'x-amz-target': 'AmazonQDeveloper.ListAvailableCustomizations',
  'User-Agent': 'aws-sdk-js/1.0.27 KiroIDE-0.8.0'
};
